...
import cc.zhuzhu8.blog.entity.Posts;
import cc.zhuzhu8.blog.entity.Reply;
import cc.zhuzhu8.blog.entity.User;
import cc.zhuzhu8.blog.service.LabelService;
import cc.zhuzhu8.blog.service.PostsService;
import cc.zhuzhu8.blog.service.ReplyService;
import cc.zhuzhu8.blog.service.UserService;
...
public class PostsController extends BaseController {
    ...
    @ApiOperation("发帖接口")
    @ApiImplicitParams({
            @ApiImplicitParam(paramType = "query",name = "content", value = "帖子内容", dataType = "String"),
            @ApiImplicitParam(paramType = "query",name = "title", value = "帖子标题", dataType = "String"),
            @ApiImplicitParam(paramType = "query",name = "token", value = "用户令牌", dataType = "String"),
            @ApiImplicitParam(paramType = "query",name = "labelId", value = "标签ID", dataType = "Integer")
    })
    @PostMapping
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(paramType = "query",name = "search", value = "查询条件", dataType = "int"),
            @ApiImplicitParam(paramType = "query",name = "type", value = "帖子类型[top : good : ]", dataType = "String"),
            @ApiImplicitParam(paramType = "query",name = "pageNo", value = "页码[从1开始]", dataType = "int"),
            @ApiImplicitParam(paramType = "query",name = "length", value = "返回结果数量[默认10]", dataType = "int")
    })
    @GetMapping()
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(paramType = "path",name = "postsid", value = "帖子的id", dataType = "int"),
            @ApiImplicitParam(paramType = "query",name = "pageNo", value = "页码[从1开始]", dataType = "int"),
            @ApiImplicitParam(paramType = "query",name = "length", value = "返回结果数量[默认10]", dataType = "int")
    })
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(paramType = "path",name = "labelid", value = "标签的id", dataType = "int"),
            @ApiImplicitParam(paramType = "query",name = "pageNo", value = "页码[从1开始]", dataType = "int"),
            @ApiImplicitParam(paramType = "query",name = "length", value = "返回结果数量[默认20]", dataType = "int"),
    })
