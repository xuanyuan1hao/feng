...
public class UserController extends BaseController {
    ...
    @ApiOperation("注册接口")
    @ApiImplicitParams({
            @ApiImplicitParam(paramType = "query",name = "email", value = "用户邮箱",dataType = "String"),
    ...
    @PostMapping("/login")
    public QuarkResult Login(@RequestParam("email") String email,@RequestParam("password") String password) {
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(paramType = "path",name = "token", value = "发送给用户的唯一令牌",dataType = "String"),
    })
    @GetMapping("/{token}")
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(paramType = "path",name = "token", value = "发送给用户的唯一令牌",dataType = "String"),
            @ApiImplicitParam(paramType = "query",name = "username", value = "要修改的用户名",dataType = "String"),
            @ApiImplicitParam(paramType = "query",name = "signature", value = "用户签名",dataType = "String"),
            @ApiImplicitParam(paramType = "query",name = "sex", value = "要修改的性别：数值0为男，1为女",dataType = "int"),
    })
    @PutMapping("/{token}")
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(paramType = "path",name = "token", value = "发送给用户的唯一令牌",dataType = "String"),
            @ApiImplicitParam(paramType = "query",name = "newpsd",value = "新的密码",dataType = "String"),
            @ApiImplicitParam(paramType = "query",name = "oldpsd",value = "新的密码",dataType = "String"),
    })
    ...
    @ApiOperation("登出用户")
    @ApiImplicitParams({
            @ApiImplicitParam(paramType = "query",name = "token", value = "发送给用户的唯一令牌",dataType = "String")
    })
    @PostMapping("/logout")
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(paramType = "path",name = "id", value = "用户的id", dataType = "int")
    })
